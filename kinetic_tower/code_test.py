...
if __name__ == "__main__":
    ...
    p2 = Player(player_ID='PLAYER 2', input_channel=24, power_sensor=p2_ina219)
    p1 = Player(player_ID='PLAYER 1', input_channel=25, power_sensor=p1_ina219)
    ...
    while True:
        ...
        #     pass
            ...
            result_leds = AnimationGroup(
                ...
                Rainbow(game.not_winner.pixel_map, 0.1, 10),
            )
            while game.game_status == RESULTS:
